...
<div class="grid h-screen place-items-center bg-fixed bg-cover bg-center" style="background-image: url({{asset('storage/img/rachids-php-developer-backend-quebec.png')}})">
    <div class="text-white text-center backdrop-blur-sm bg-orange-300/30 p-7 rounded-md">
        ...
        <div class="mt-5 flex justify-center gap-20">
            <a href="https://www.linkedin.com/in/rsebb/" class="text-white hover:text-orange-300">
            ...
            <a href="https://www.youtube.com/channel/UCsmtNx-781JBVIDw6bNkKvw" class="text-moutarde hover:text-orange-300">
            ...
            <a href="https://www.twitch.tv/rachids_ca" class="text-moutarde hover:text-orange-300">
